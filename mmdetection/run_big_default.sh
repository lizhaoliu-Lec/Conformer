...
CONFIG="./configs/faster_rcnn/faster_rcnn_wide_conformer_small_patch16_fpn_1x_coco.py"
WORK_DIR='./work_dir/faster_rcnn_wide_conformer_small_patch16_lr_1e_4_fpn_1x_coco_1344_800'
