...
WORK_DIR='./work_dir/faster_rcnn_wide_conformer_small_patch16_lr_1e_4_fpn_1x_uadetrac_1344_800_21k'
...
python -m torch.distributed.launch --nproc_per_node=${GPU_NUM} --master_port=50040 --use_env ./tools/train.py ${CONFIG} --work-dir ${WORK_DIR} --gpus ${GPU_NUM}  --launcher pytorch --cfg-options model.pretrained='./pretrain_models/WideConformer_small_patch16_21k.pth' model.backbone.patch_size=16
