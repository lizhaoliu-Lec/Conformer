...
CONFIG="./configs/faster_rcnn/faster_rcnn_wide_conformer_small_patch16_fpn_1x_uadetrac_1class.py"
WORK_DIR='./work_dir/faster_rcnn_wide_conformer_small_patch16_lr_1e_4_fpn_1x_uadetrac_1class_1344_800'
