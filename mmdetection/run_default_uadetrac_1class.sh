...
CONFIG="./configs/faster_rcnn/faster_rcnn_conformer_small_patch32_fpn_1x_uadetrac_1class.py"
WORK_DIR='./work_dir/faster_rcnn_conformer_small_patch32_lr_1e_4_fpn_1x_uadetrac_1class_1344_800'
